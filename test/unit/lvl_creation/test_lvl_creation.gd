...
var INVALID_FARM = "res://test/test_levels/lvl_creation_testers/invalid_farm.txt"
...
func test_valid_level():
	var file = FileAccess.open(VALID_FARM, FileAccess.WRITE)
	file.store_string("#,r,s,#\n#,w,l,#\n#,#,#,#")
	file.close()
...
func test_invalid_level():
	var file = FileAccess.open(INVALID_FARM, FileAccess.WRITE)
	file.store_string("#,r,s,#\n#,w,l,#")
	file.close()
	...
	DirAccess.remove_absolute(INVALID_FARM)
	
	file = FileAccess.open(INVALID_FARM, FileAccess.WRITE)
	file.store_string("#,r,s,#\n#,w,l,#\nw,#,#,#\n#,#,#,#")
	file.close()
	
	result = level_loader.create(INVALID_FARM)
	assert_eq(result, null, "Should return null for invalid farm")
